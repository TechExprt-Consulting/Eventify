    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={3} sm={3} md={3} lg={3}  >
          ...
          <Grid itemxs={12} sm={12} md={12} lg={12}>
                ...
                >
                  <h4 className=''>Language</h4><h4 > { isAttributesVisible== false ? <KeyboardArrowDownSharpIcon /> : <KeyboardArrowUpSharpIcon/>}</h4>
                ...
                >
                  <h4 className=''>Genres</h4><h4 > { isAttributesVisiblesecond== false ? <KeyboardArrowDownSharpIcon /> : <KeyboardArrowUpSharpIcon/>}</h4>
      ...
      <Grid item xs={9} sm={9} md={9} lg={9}  style={{ marginTop: '20px' }}>
         <Eventcard />
      </Grid>
    </Grid>
